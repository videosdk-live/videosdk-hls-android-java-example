...
public class NetworkUtils {
        ...
        .getAsJSONObject(
          new JSONObjectRequestListener() {
            ...
            public void onError(ANError anError) {
              ...
              Toast
                .makeText(context, anError.getErrorDetail(), Toast.LENGTH_SHORT)
                .show();
            }
          }
        );
  ...
  public void createMeeting(
    String token,
    ResponseListener<String> meetingEventListener
  ) {
    AndroidNetworking
      ...
      .getAsJSONObject(
        new JSONObjectRequestListener() {
          ...
          public void onError(ANError anError) {
            anError.printStackTrace();
            Toast
              .makeText(context, anError.getMessage(), Toast.LENGTH_SHORT)
              .show();
          }
        }
      );
